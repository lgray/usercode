...
def main(**kwargs) :
    ...
    if options.nproc > 1 : #multiprocessing!
        ...
        write_config( alg_list, options.confFileName, options.treeName, output_file, options.files )
...
def write_source_file(source_file_name, header_file_name, branches, keep_branches=[]) :
    ...
    branch_setting.write('#include "BasicFilter/BranchInit.h"\n')
    branch_setting.write('#include "BasicFilter/BranchDefs.h"\n\n')
