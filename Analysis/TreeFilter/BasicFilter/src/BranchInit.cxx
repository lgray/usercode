...
void CopyInputVarsToOutput() {
  OUT::nMC = IN::nMC;
  std::copy(IN::mcPID, IN::mcPID+69, OUT::mcPID);
   std::copy(IN::mcVtx, IN::mcVtx+207, OUT::mcVtx);
   std::copy(IN::mcPt, IN::mcPt+69, OUT::mcPt);
   std::copy(IN::mcMass, IN::mcMass+69, OUT::mcMass);
   std::copy(IN::mcEta, IN::mcEta+69, OUT::mcEta);
   std::copy(IN::mcPhi, IN::mcPhi+69, OUT::mcPhi);
   std::copy(IN::mcE, IN::mcE+69, OUT::mcE);
   std::copy(IN::mcEt, IN::mcEt+69, OUT::mcEt);
   std::copy(IN::mcGMomPID, IN::mcGMomPID+69, OUT::mcGMomPID);
   std::copy(IN::mcMomPID, IN::mcMomPID+69, OUT::mcMomPID);
   std::copy(IN::mcMomPt, IN::mcMomPt+69, OUT::mcMomPt);
   std::copy(IN::mcMomMass, IN::mcMomMass+69, OUT::mcMomMass);
   std::copy(IN::mcMomEta, IN::mcMomEta+69, OUT::mcMomEta);
   std::copy(IN::mcMomPhi, IN::mcMomPhi+69, OUT::mcMomPhi);
   std::copy(IN::mcIndex, IN::mcIndex+69, OUT::mcIndex);
   std::copy(IN::mcDecayType, IN::mcDecayType+69, OUT::mcDecayType);
   std::copy(IN::mcParentage, IN::mcParentage+69, OUT::mcParentage);
   std::copy(IN::mcStatus, IN::mcStatus+69, OUT::mcStatus);
 }
