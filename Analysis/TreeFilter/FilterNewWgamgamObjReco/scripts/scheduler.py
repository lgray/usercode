...
for base, job in jobs :
    command = command_base %{ 'base' : base, 'job' : job, 'nfiles' : nFilesPerJob, 'nsplit' : nSplit, 'output' : output, 'nsplit': nSplit, 'nproc' : nProc }
    print command
    os.system(command)
