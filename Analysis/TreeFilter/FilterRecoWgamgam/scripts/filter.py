...
#    sys.exit(-1)
#
#def_file_name = workarea    + '/TreeFilter/FilterRecoWgamgam/FilterRecoWgamgam/BranchDefs.h'
#header_file_name = workarea + '/TreeFilter/FilterRecoWgamgam/FilterRecoWgamgam/BranchInit.h'
#source_file_name = workarea + '/TreeFilter/FilterRecoWgamgam/src/BranchInit.cxx'
...
def main(**kwargs) :
    ...
    #branches = core.get_branch_mapping(input_files, options.treeName )
    ...
    #    exe_path = '%s/TreeFilter/FilterRecoWgamgam/RunAnalysis' %workarea
