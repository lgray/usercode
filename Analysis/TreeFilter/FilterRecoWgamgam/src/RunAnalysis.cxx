...
void RunModule::BuildElectron( ModuleConfig & config ) const {
    ...
    for( int idx = 0; idx < IN::nEle; ++idx ) {
        ...
        if( fabs(sceta) < 1.479 ) { // barrel
            ...
            // Tight cuts
            if( !config.PassFloat( "cut_dEtaIn_endcap_tight"    , dEtaIn       ) ) pass_tight=false;
            if( !config.PassFloat( "cut_dPhiIn_endcap_tight"    , dPhiIn       ) ) pass_tight=false;
            ...
            if( !config.PassFloat( "cut_pfIso30_endcap_tight"   , pfiso30/pt   ) ) pass_tight=false;
            ...
            // Medium cuts
            if( !config.PassFloat( "cut_dEtaIn_endcap_medium"    , dEtaIn       ) ) pass_medium=false;
            if( !config.PassFloat( "cut_dPhiIn_endcap_medium"    , dPhiIn       ) ) pass_medium=false;
            ...
            if( !config.PassFloat( "cut_pfIso30_endcap_medium"   , pfiso30/pt   ) ) pass_medium=false;
            ...
            // Loose cuts
            if( !config.PassFloat( "cut_dEtaIn_endcap_loose"    , dEtaIn       ) ) pass_loose=false;
            if( !config.PassFloat( "cut_dPhiIn_endcap_loose"    , dPhiIn       ) ) pass_loose=false;
            ...
            if( !config.PassFloat( "cut_pfIso30_endcap_loose"   , pfiso30/pt   ) ) pass_loose=false;
            ...
            // Very Loose cuts
            if( !config.PassFloat( "cut_dEtaIn_endcap_veryloose"    , dEtaIn       ) ) pass_veryloose=false;
            if( !config.PassFloat( "cut_dPhiIn_endcap_veryloose"    , dPhiIn       ) ) pass_veryloose=false;
