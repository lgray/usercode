...
#    sys.exit(-1)
#
#def_file_name    = workarea + '/TreeFilter/FilterWgamgam/FilterWgamgam/BranchDefs.h'
#header_file_name = workarea + '/TreeFilter/FilterWgamgam/FilterWgamgam/BranchInit.h'
#source_file_name = workarea + '/TreeFilter/FilterWgamgam/src/BranchInit.cxx'
...
def main(**kwargs) :
    ...
    #    exe_path = '%s/TreeFilter/FilterWgamgam/RunAnalysis' %workarea
    ...
    #           'WorkArea environment variable to the directory where TreeFilter '
