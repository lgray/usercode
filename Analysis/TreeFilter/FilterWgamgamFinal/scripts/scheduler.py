...
top_configs = [ 
                ...
                #  'output_name' : 'DiLepton_2014_01_14',
                #  'tag'         : 'll',
                #},
                #{ 
                #  'module'   : 'ConfObjFilter.py',
                ...
                #  'output_name' : 'LepGamma_2014_01_21',
                #  'tag'         : 'lg',
                #},
                { 
                  'module'   : 'ConfObjFilter.py',
                  'args_mc'  : '{ \'cut_nLep25\' : \'>= 0\' }',
                  'args_data'  : '{ \'cut_nLep25\' : \'>= 0\' }',
                  'output_name' : 'LepGammaNoFilt_2014_01_21',
                  'tag'         : 'singlel',
                },
                #{ 
