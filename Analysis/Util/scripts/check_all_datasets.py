...
#base_filtered ='/eos/cms/store/user/abelloni/Wgamgam/FilteredSamplesDec13'
#base_filtered ='/eos/cms/store/user/jkunkle/Wgamgam/FilteredSamplesDec13'
base_filtered = '/eos/cms/store/user/jkunkle/Wgamgam/RecoOutputREDO_2013_12_07'
#base_all = '/eos/cms/store/user/jkunkle/Wgamgam/FilteredSamplesDec13/'
base_all = '/eos/cms/store/group/phys_egamma/cmkuo/'



job_conf = [
            #(base_all, 'job_summer12_DiPhotonBorn_Pt-10To25'),
            ...
            #(base_all, 'job_summer12_ttinclusive'),
